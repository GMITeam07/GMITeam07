...
Feature: sign in feature
  ...
  Scenario Outline:US_013 - User should create a new account
    ...
    Examples:
     ...
     # | Active account     | 357_0000 | Saving      | Active        | 2020-11-11 10:00 PM | 2029-12-10 2:00 PM | random   |
     # | CreditCard Account | 12500ABC | Credit_Card | Active        | 2020-11-13 5:00 PM  | 2021-04-18 1:00 AM | random   |
