...
public class UserInfoSettingsPositiveTest {
    ...
    public void user_verifies_language_drop_down_menu_has_and_options(String string, String string2) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void user_retrieves_the_user_info_by_api(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
    ...
    public void user_retrieves_the_user_info_by_database(String string) {
        // Write code here that turns the phrase above into concrete actions
        throw new io.cucumber.java.PendingException();
    }
