...
Feature: US_27 System should allow to delete states using api endpoint
  ...
  Scenario: TC_2701 before DELETE request
    Given User sends a GET request to REST API endpoint "https://www.gmibank.com/api/tp-states"
    ...
    Then Before delete request id should be "25368"
    Then Before delete request name should be "Auvergne"

  @TC_2702
  Scenario: TC_2702 check DELETE request
    Given User sends a DELETE request to REST API endpoint "https://www.gmibank.com/api/tp-states/25368"
